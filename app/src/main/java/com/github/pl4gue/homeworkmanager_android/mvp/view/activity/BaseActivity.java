package com.github.pl4gue.homeworkmanager_android.mvp.view.activity;
...
public class BaseActivity extends AppCompatActivity {
    ...
    public static class DialogManagers {
        public static class ProgressDialogManager {
            ...
            public static void startProgressDialog(String title) {
        ...
        public static class DatePickerManager {
            public static void datePickerDialog(Calendar calendar, Context context, EditText dueDateEditText) {
